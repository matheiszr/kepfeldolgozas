...
//					runCountOnInputImage(inputPath); //FIXME elesben ezeket vissza tenni!!!!!
					String imagePath= System.getProperty("user.dir") 
							+ "\\src\\main\\resources\\test\\test_8.jpg"; // FIXME elesben ezt kommentezd ki!!!!!
	 ...
	 * @param imagePath (your image which would you like count)
	 * @throws Exception
	 */
	private static void runCountOnInputImage(String imagePath) throws Exception {
		List<Card> cards = new ImageToCardsConverter().getCards(imagePath);
		whatIsTheHand(cards);
	}
	...
	/**
	 * This method print to the terminal what is the hand and print the recognized cards.
	 * @param hand (List of Card entities which contains 5 cards)
	 * @throws Exception
	 */
